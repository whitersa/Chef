...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:import xmlns:dita="http://dita-ot.sourceforge.net" href="plugin:com.chefos.pdf:cfg/fo/xsl/custom.xsl"/><xsl:import href="plugin:com.chefos.pdf:cfg/fo/attrs/custom.xsl"/>
