...
export class AddCommentsToEntities1764307899901 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`COMMENT ON TABLE "ingredient" IS 'Raw ingredients used in recipes'`);
    ...
    await queryRunner.query(`COMMENT ON TABLE "menu" IS 'Application navigation menu items'`);
    await queryRunner.query(`COMMENT ON TABLE "user" IS 'System users including chefs and staff'`);
    await queryRunner.query(
    ...
    await queryRunner.query(`COMMENT ON COLUMN "ingredient"."name" IS 'Name of the ingredient'`);
    await queryRunner.query(`COMMENT ON COLUMN "ingredient"."price" IS 'Cost price per unit'`);
    await queryRunner.query(
    ...
    await queryRunner.query(`COMMENT ON COLUMN "recipe_item"."quantity" IS 'Quantity required'`);
    await queryRunner.query(
    ...
    await queryRunner.query(`COMMENT ON COLUMN "menu"."title" IS 'Display title of the menu item'`);
    await queryRunner.query(`COMMENT ON COLUMN "menu"."path" IS 'Navigation path/route'`);
    await queryRunner.query(`COMMENT ON COLUMN "menu"."icon" IS 'Icon name for the menu item'`);
    await queryRunner.query(`COMMENT ON COLUMN "menu"."order" IS 'Display order of the menu item'`);
    await queryRunner.query(
      `COMMENT ON COLUMN "menu"."parentId" IS 'Unique identifier for the menu item'`,
    );
    await queryRunner.query(`COMMENT ON COLUMN "user"."id" IS 'Unique identifier for the user'`);
    await queryRunner.query(`COMMENT ON COLUMN "user"."name" IS 'Full name of the user'`);
    await queryRunner.query(`COMMENT ON COLUMN "user"."username" IS 'Unique username for login'`);
    await queryRunner.query(`COMMENT ON COLUMN "user"."password" IS 'Hashed password'`);
    await queryRunner.query(
    ...
    await queryRunner.query(`COMMENT ON COLUMN "user"."preferences" IS 'User UI preferences'`);
    await queryRunner.query(`COMMENT ON COLUMN "user"."createdAt" IS 'Record creation timestamp'`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`COMMENT ON COLUMN "processing_method"."description" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "processing_method"."name" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "processing_method"."id" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "recipe"."preProcessing" IS NULL`);
    ...
    await queryRunner.query(`COMMENT ON COLUMN "recipe_item"."childRecipeId" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "recipe_item"."ingredientId" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "recipe_item"."recipeId" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "recipe_item"."yieldRate" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "recipe_item"."quantity" IS NULL`);
    ...
    await queryRunner.query(`COMMENT ON COLUMN "ingredient"."updatedAt" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "ingredient"."createdAt" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "ingredient"."nutrition" IS NULL`);
