...
const service = new DitaGeneratorService();
const recipe = {
  id: '123',
  name: 'Test Recipe',
  variantName: 'Delicious Variant',
  items: [{ quantity: 1, ingredient: { name: 'Salt', unit: 'tsp' } }],
  preProcessing: [{ type: 'chop', description: 'Chop onions' }],
  steps: ['Mix ingredients', 'Cook']
};

console.log(service.generateRecipeTopic(recipe));
