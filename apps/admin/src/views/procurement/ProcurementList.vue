    ...
    <el-card class="box-card">
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            ...
            <el-button type="primary" :loading="loading" @click="generateList">
              生成清单
            </el-button>
          </div>
        </div>
        ...
        <el-tabs v-model="activeTab" class="demo-tabs">
          <el-tab-pane label="按菜谱添加" name="recipe">
            <el-form :inline="true">
              ...
              <el-form-item>
                <el-button :disabled="!selectedRecipeId" @click="addRecipe"> 添加 </el-button>
              </el-form-item>
            </el-form>
            ...
            <el-table :data="requestItems" style="width: 100%; margin-bottom: 20px" border>
              ...
              <el-table-column label="操作" width="100">
                <template #default="scope">
                  <el-button type="danger" link @click="removeRecipe(scope.$index)">
                    移除
                  </el-button>
                </template>
              </el-table-column>
          ...
          <el-tab-pane label="按销售菜单添加" name="menu">
            <el-form :inline="true">
              ...
              <el-form-item>
                <el-button :disabled="!selectedMenuId" @click="addMenu"> 添加 </el-button>
              </el-form-item>
            </el-form>
      ...
      <div v-if="resultList.length > 0" class="result-section">
        <div class="result-header">
          ...
          <el-button type="success" :loading="saving" @click="saveProcurement">
            保存采购单
          </el-button>
        </div>
